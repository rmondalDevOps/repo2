...
public class TS73_DesignPage_StepSchedulingConfigurationTest_3 extends TestBase{

	CommonFunction cfunction = new CommonFunction();
	String msg = "";

	public void workflow_TS73_DesignPage_StepSchedulingConfigurationTest_3() throws InterruptedException {
		...
		//Click on Diagram in left menu
				...
				try {
					SikuliHelp.selectLocationOnMapSikuliClick("TS73_ManualStep1_1366x768");
					cfunction.sync(2);
				...
				cfunction.sync(2);
				msg = "Enter Step name as \"Manual Step B\"";
				try {
					Design.enterStepName("Manual Step B");
					CommonFunction.logStatus("PASS", msg);
				} catch (Exception e) {
					e.printStackTrace();
					CommonFunction.logStatus("FAIL", msg);
		...
		//Open Time drop down list and choose "Day of Week"
				msg = "Open Time drop down list and choose \"Day Of Week\"";
				try {
					Design.selectTimeFromDropDown("Day of Week");
					CommonFunction.logStatus("PASS", msg);
				} catch (Exception e) {
					e.printStackTrace();
					CommonFunction.logStatus("FAIL", msg);
				...
				cfunction.sync(2);
		//The Day of Week is selected. The Day drop down is populated with 7 week days. The default time to run the step is 00:00.
		//Pick a week day as "Monday" from the list
				msg = "Open day drop down list and choose \"Monday\"";
				try {
					Design.selectDayFromDropDown("Monday");
					CommonFunction.logStatus("PASS", msg);
				} catch (Exception e) {
					e.printStackTrace();
					CommonFunction.logStatus("FAIL", msg);
				...
				cfunction.sync(2);
		//Set the run time to 8:00 
				msg = "Pick a time to run the step by opening the time picker: 8:00";
				try {
					Design.enterTimeInput("08:00");
					CommonFunction.logStatus("PASS", msg);
				} catch (Exception e) {
					e.printStackTrace();
					CommonFunction.logStatus("FAIL", msg);
				...
				cfunction.sync(2);
		//Leave Offset to 3 as default
				msg = "Enter Offset=3";
				try {
					Design.enterMonthInput(1,"3");
					cfunction.sync(2);
					Design.clickOnWaitUntilASpecificTimeRadioBtn();
					CommonFunction.logStatus("PASS", msg);
				} catch (Exception e) {
